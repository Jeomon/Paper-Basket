<template>
    <div class="bg-slate-200 w-full h-auto py-[6vh] mt-16" >
        <div class="w-[90%] max-w-xl p-6 bg-slate-100 mx-auto shadow-md rounded-md">
            <h1 class="text-4xl mt-2 mb-6 text-slate-700">Sign Up<span class="text-base font-medium"> (Customer)</span></h1>
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full">
                        ...
                        <p class="my-3 text-slate-600 text-base font-medium">Already have an account? 
                            <RouterLink class="text-blue-400" :to="{name: 'customer_signin'}">Sign In</RouterLink>  now
                        </p>
                    </div>
                </div>
            </form>
...
<script>
    import { helpers,required,maxLength,email,numeric } from '@vuelidate/validators'
    ...
    export default {
        ...
        validations: {
            form: {
                    ...
                    mobile_no: {
                        required :helpers.withMessage("This field is required",required),
                        numeric :helpers.withMessage("This field is require numbers",numeric),
            ...
            isagreed: {
                isagreed: helpers.withMessage("Your acknowledgment to our terms is required.",value=>value)
            }
        },
        methods: {
            async submit(){
