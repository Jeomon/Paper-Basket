<template>
    <div class="relative w-full bg-slate-200 min-h-[90vh] top-[10vh]">
        <div class="mx-6 flex flex-col">
            <div class="bg-slate-200 w-full">
                <div class="w-full py-3 px-3 bg-slate-100 my-10 shadow-md">
                    <h1 class="text-4xl text-slate-700">Delete Account</h1>
                </div>
            </div>
            <div class="mx-[3%] py-7">
                <p class="indent-10 text-justify font-medium text-slate-500 text-lg">
                    We're sorry to see you go! At Paper Basket, we understand that circumstances may change, 
                    and you may need to delete your account. We're here to assist you with a hassle-free account deletion process. 
                    Before proceeding, we want to ensure that you are fully informed about the consequences of deleting your account:
                    You will no longer have access to exclusive offers, and discounts. You will need to create a new account if you wish to shop with us again in the future.
                    If you still wish to proceed with deleting your account, please click the button below.
                </p>
        ...
        <div :class="[{'hidden':!toggleDelete}, 'fixed', 'top-[10vh]', 'left-20vw', 'w-[60%]', 'sm:w-[70%]', 'lg:w-[80%]', 'h-[90vh]', 'bg-black/70', 'backdrop-blur-sm']">
            <div class="w-fit p-6 mx-[2%] md:mx-[20%] lg:mx-[30%] my-[10vh] text-center bg-slate-300 rounded-md">
...
<script>
    export default {
        ...
        methods: {
            ...
            async onDelete(e){
                this.$store.dispatch('delete_user','customer')
            }
        },
    }
</script>